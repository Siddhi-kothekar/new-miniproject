...
import { FaComments, FaGraduationCap, FaPlay } from 'react-icons/fa';
...
function Cards({ item }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl">
